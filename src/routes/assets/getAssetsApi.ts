...
// 获取资产
export function createGetAssetsRouter(resolveWork: () => DatabaseWork = () => getDatabaseRuntime().work) {
  ...
  router.post(
    ...
    async (req, res) => {
      ...
      // 统计总数
      const totalQuery = (await resolveWork()((db) =>
        db("o_assets")
...
export default createGetAssetsRouter();

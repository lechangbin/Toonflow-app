// @routes-hash 85e994f12e3bd2fce88b44ea41bf191f
...
import route23 from "./routes/modelSelect/getModelDetail";
import route24 from "./routes/modelSelect/getModelList";
import route25 from "./routes/novel/addNovel";
import route26 from "./routes/novel/batchDeleteNovel";
import route27 from "./routes/novel/delNovel";
import route28 from "./routes/novel/event/batchDeleteEvent";
import route29 from "./routes/novel/event/deletEvent";
import route30 from "./routes/novel/event/generateEvents";
import route31 from "./routes/novel/event/getEvent";
...
import route36 from "./routes/production/getProductionData";
...
export default async (app: Express) => {
  ...
  app.use("/api/modelSelect/getModelDetail", route23);
  app.use("/api/modelSelect/getModelList", route24);
  app.use("/api/novel/addNovel", route25);
  app.use("/api/novel/batchDeleteNovel", route26);
  app.use("/api/novel/delNovel", route27);
  app.use("/api/novel/event/batchDeleteEvent", route28);
  app.use("/api/novel/event/deletEvent", route29);
  app.use("/api/novel/event/generateEvents", route30);
  app.use("/api/novel/event/getEvent", route31);
  app.use("/api/novel/getNovel", route32);
  app.use("/api/novel/updateNovel", route33);
  app.use("/api/other/deleteAllData", route34);
  app.use("/api/other/getCaptcha", route35);
  app.use("/api/production/getProductionData", route36);

// @routes-hash 107ba18f58fabde254ec85ec7d194a6f
...
import route94 from "./routes/project/getModelDetails";
...
import route104 from "./routes/script/getAiRegex";
import route105 from "./routes/script/getScrptApi";
import route106 from "./routes/script/pollScriptAssets";
import route107 from "./routes/script/updateScript";
import route108 from "./routes/scriptAgent/getPlanData";
import route109 from "./routes/scriptAgent/setPlanData";
import route110 from "./routes/scriptAgent/updateData";
import route111 from "./routes/setting/about/checkUpdate";
import route112 from "./routes/setting/about/downloadApp";
import route113 from "./routes/setting/agentDeploy/agentSetKey";
import route114 from "./routes/setting/agentDeploy/deployAgentModel";
import route115 from "./routes/setting/agentDeploy/getAgentDeploy";
import route116 from "./routes/setting/dbConfig/clearData";
import route117 from "./routes/setting/dbConfig/clearTable";
import route118 from "./routes/setting/dbConfig/dbInfo";
import route119 from "./routes/setting/dbConfig/exportData";
import route120 from "./routes/setting/dbConfig/importData";
import route121 from "./routes/setting/dev/getSwitchAiDevTool";
import route122 from "./routes/setting/dev/updateSwitchAiDevTool";
import route123 from "./routes/setting/fileManagement/openFolder";
import route124 from "./routes/setting/getTextModel";
import route125 from "./routes/setting/loginConfig/getUser";
import route126 from "./routes/setting/loginConfig/updateUserPwd";
import route127 from "./routes/setting/memoryConfig/delAllMemory";
import route128 from "./routes/setting/memoryConfig/getMemory";
import route129 from "./routes/setting/memoryConfig/sureMemory";
import route130 from "./routes/setting/modelMap/bindingPrompt";
import route131 from "./routes/setting/modelMap/getImageAndVideoModel";
import route132 from "./routes/setting/promptManage/getPrompt";
import route133 from "./routes/setting/promptManage/updatePrompt";
import route134 from "./routes/setting/skillManagement/getSkillContent";
import route135 from "./routes/setting/skillManagement/getSkillList";
import route136 from "./routes/setting/skillManagement/saveSkillContent";
import route137 from "./routes/setting/vendorConfig/addVendor";
import route138 from "./routes/setting/vendorConfig/addVendorModel";
import route139 from "./routes/setting/vendorConfig/deleteVendor";
import route140 from "./routes/setting/vendorConfig/delVendorModel";
import route141 from "./routes/setting/vendorConfig/enableVendor";
import route142 from "./routes/setting/vendorConfig/getCodeByLink";
import route143 from "./routes/setting/vendorConfig/getVendorList";
import route144 from "./routes/setting/vendorConfig/modelTest";
import route145 from "./routes/setting/vendorConfig/updateCode";
import route146 from "./routes/setting/vendorConfig/updateVendorInputs";
import route147 from "./routes/setting/vendorConfig/upVendorModel";
import route148 from "./routes/task/getProject";
import route149 from "./routes/task/getTaskApi";
import route150 from "./routes/task/getTaskCategories";
import route151 from "./routes/task/taskDetails";
import route152 from "./routes/test/test";
...
export default async (app: Express) => {
  ...
  app.use("/api/project/getModelDetails", route94);
  ...
  app.use("/api/script/getAiRegex", route104);
  app.use("/api/script/getScrptApi", route105);
  app.use("/api/script/pollScriptAssets", route106);
  app.use("/api/script/updateScript", route107);
  app.use("/api/scriptAgent/getPlanData", route108);
  app.use("/api/scriptAgent/setPlanData", route109);
  app.use("/api/scriptAgent/updateData", route110);
  app.use("/api/setting/about/checkUpdate", route111);
  app.use("/api/setting/about/downloadApp", route112);
  app.use("/api/setting/agentDeploy/agentSetKey", route113);
  app.use("/api/setting/agentDeploy/deployAgentModel", route114);
  app.use("/api/setting/agentDeploy/getAgentDeploy", route115);
  app.use("/api/setting/dbConfig/clearData", route116);
  app.use("/api/setting/dbConfig/clearTable", route117);
  app.use("/api/setting/dbConfig/dbInfo", route118);
  app.use("/api/setting/dbConfig/exportData", route119);
  app.use("/api/setting/dbConfig/importData", route120);
  app.use("/api/setting/dev/getSwitchAiDevTool", route121);
  app.use("/api/setting/dev/updateSwitchAiDevTool", route122);
  app.use("/api/setting/fileManagement/openFolder", route123);
  app.use("/api/setting/getTextModel", route124);
  app.use("/api/setting/loginConfig/getUser", route125);
  app.use("/api/setting/loginConfig/updateUserPwd", route126);
  app.use("/api/setting/memoryConfig/delAllMemory", route127);
  app.use("/api/setting/memoryConfig/getMemory", route128);
  app.use("/api/setting/memoryConfig/sureMemory", route129);
  app.use("/api/setting/modelMap/bindingPrompt", route130);
  app.use("/api/setting/modelMap/getImageAndVideoModel", route131);
  app.use("/api/setting/promptManage/getPrompt", route132);
  app.use("/api/setting/promptManage/updatePrompt", route133);
  app.use("/api/setting/skillManagement/getSkillContent", route134);
  app.use("/api/setting/skillManagement/getSkillList", route135);
  app.use("/api/setting/skillManagement/saveSkillContent", route136);
  app.use("/api/setting/vendorConfig/addVendor", route137);
  app.use("/api/setting/vendorConfig/addVendorModel", route138);
  app.use("/api/setting/vendorConfig/deleteVendor", route139);
  app.use("/api/setting/vendorConfig/delVendorModel", route140);
  app.use("/api/setting/vendorConfig/enableVendor", route141);
  app.use("/api/setting/vendorConfig/getCodeByLink", route142);
  app.use("/api/setting/vendorConfig/getVendorList", route143);
  app.use("/api/setting/vendorConfig/modelTest", route144);
  app.use("/api/setting/vendorConfig/updateCode", route145);
  app.use("/api/setting/vendorConfig/updateVendorInputs", route146);
  app.use("/api/setting/vendorConfig/upVendorModel", route147);
  app.use("/api/task/getProject", route148);
  app.use("/api/task/getTaskApi", route149);
  app.use("/api/task/getTaskCategories", route150);
  app.use("/api/task/taskDetails", route151);
  app.use("/api/test/test", route152);
}

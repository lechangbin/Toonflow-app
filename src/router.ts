// @routes-hash 490361155cc6fa7ac97f72f183a52eb3
...
import route121 from "./routes/setting/agentDeploy/getAgentUseMode";
import route122 from "./routes/setting/agentDeploy/updateUseMode";
import route123 from "./routes/setting/dbConfig/clearData";
import route124 from "./routes/setting/dbConfig/clearTable";
import route125 from "./routes/setting/dbConfig/dbInfo";
import route126 from "./routes/setting/dbConfig/exportData";
import route127 from "./routes/setting/dbConfig/importData";
import route128 from "./routes/setting/dev/getSwitchAiDevTool";
import route129 from "./routes/setting/dev/updateSwitchAiDevTool";
import route130 from "./routes/setting/fileManagement/openFolder";
import route131 from "./routes/setting/getTextModel";
import route132 from "./routes/setting/loginConfig/getUser";
import route133 from "./routes/setting/loginConfig/updateUserPwd";
import route134 from "./routes/setting/memoryConfig/delAllMemory";
import route135 from "./routes/setting/memoryConfig/getMemory";
import route136 from "./routes/setting/memoryConfig/sureMemory";
import route137 from "./routes/setting/modelMap/bindingPrompt";
import route138 from "./routes/setting/modelMap/deletePrompt";
import route139 from "./routes/setting/modelMap/getImageAndVideoModel";
import route140 from "./routes/setting/modelMap/getPromptList";
import route141 from "./routes/setting/modelMap/savePrompt";
import route142 from "./routes/setting/modelMap/updatePrompt";
import route143 from "./routes/setting/promptManage/getPrompt";
import route144 from "./routes/setting/promptManage/updatePrompt";
import route145 from "./routes/setting/skillManagement/getSkillContent";
import route146 from "./routes/setting/skillManagement/getSkillList";
import route147 from "./routes/setting/skillManagement/saveSkillContent";
import route148 from "./routes/setting/vendorConfig/addVendor";
import route149 from "./routes/setting/vendorConfig/addVendorModel";
import route150 from "./routes/setting/vendorConfig/deleteVendor";
import route151 from "./routes/setting/vendorConfig/delVendorModel";
import route152 from "./routes/setting/vendorConfig/enableVendor";
import route153 from "./routes/setting/vendorConfig/getCodeByLink";
import route154 from "./routes/setting/vendorConfig/getVendorList";
import route155 from "./routes/setting/vendorConfig/modelTest";
import route156 from "./routes/setting/vendorConfig/modelTest/imageTest";
import route157 from "./routes/setting/vendorConfig/modelTest/textTest";
import route158 from "./routes/setting/vendorConfig/modelTest/videoTest";
import route159 from "./routes/setting/vendorConfig/updateCode";
import route160 from "./routes/setting/vendorConfig/updateVendorInputs";
import route161 from "./routes/setting/vendorConfig/upVendorModel";
import route162 from "./routes/task/getProject";
import route163 from "./routes/task/getTaskApi";
import route164 from "./routes/task/getTaskCategories";
import route165 from "./routes/task/taskDetails";
import route166 from "./routes/test/test";
...
export default async (app: Express) => {
  ...
  app.use("/api/setting/agentDeploy/getAgentUseMode", route121);
  app.use("/api/setting/agentDeploy/updateUseMode", route122);
  app.use("/api/setting/dbConfig/clearData", route123);
  app.use("/api/setting/dbConfig/clearTable", route124);
  app.use("/api/setting/dbConfig/dbInfo", route125);
  app.use("/api/setting/dbConfig/exportData", route126);
  app.use("/api/setting/dbConfig/importData", route127);
  app.use("/api/setting/dev/getSwitchAiDevTool", route128);
  app.use("/api/setting/dev/updateSwitchAiDevTool", route129);
  app.use("/api/setting/fileManagement/openFolder", route130);
  app.use("/api/setting/getTextModel", route131);
  app.use("/api/setting/loginConfig/getUser", route132);
  app.use("/api/setting/loginConfig/updateUserPwd", route133);
  app.use("/api/setting/memoryConfig/delAllMemory", route134);
  app.use("/api/setting/memoryConfig/getMemory", route135);
  app.use("/api/setting/memoryConfig/sureMemory", route136);
  app.use("/api/setting/modelMap/bindingPrompt", route137);
  app.use("/api/setting/modelMap/deletePrompt", route138);
  app.use("/api/setting/modelMap/getImageAndVideoModel", route139);
  app.use("/api/setting/modelMap/getPromptList", route140);
  app.use("/api/setting/modelMap/savePrompt", route141);
  app.use("/api/setting/modelMap/updatePrompt", route142);
  app.use("/api/setting/promptManage/getPrompt", route143);
  app.use("/api/setting/promptManage/updatePrompt", route144);
  app.use("/api/setting/skillManagement/getSkillContent", route145);
  app.use("/api/setting/skillManagement/getSkillList", route146);
  app.use("/api/setting/skillManagement/saveSkillContent", route147);
  app.use("/api/setting/vendorConfig/addVendor", route148);
  app.use("/api/setting/vendorConfig/addVendorModel", route149);
  app.use("/api/setting/vendorConfig/deleteVendor", route150);
  app.use("/api/setting/vendorConfig/delVendorModel", route151);
  app.use("/api/setting/vendorConfig/enableVendor", route152);
  app.use("/api/setting/vendorConfig/getCodeByLink", route153);
  app.use("/api/setting/vendorConfig/getVendorList", route154);
  app.use("/api/setting/vendorConfig/modelTest", route155);
  app.use("/api/setting/vendorConfig/modelTest/imageTest", route156);
  app.use("/api/setting/vendorConfig/modelTest/textTest", route157);
  app.use("/api/setting/vendorConfig/modelTest/videoTest", route158);
  app.use("/api/setting/vendorConfig/updateCode", route159);
  app.use("/api/setting/vendorConfig/updateVendorInputs", route160);
  app.use("/api/setting/vendorConfig/upVendorModel", route161);
  app.use("/api/task/getProject", route162);
  app.use("/api/task/getTaskApi", route163);
  app.use("/api/task/getTaskCategories", route164);
  app.use("/api/task/taskDetails", route165);
  app.use("/api/test/test", route166);
}

// @routes-hash 8ce2263d4dc5c8171785529954312b92
...
import route48 from "./routes/setting/getSetting";
import route49 from "./routes/setting/updeteModel";
import route50 from "./routes/storyboard/batchSuperScoreImage";
import route51 from "./routes/storyboard/chatStoryboard";
import route52 from "./routes/storyboard/generateShotImage";
import route53 from "./routes/storyboard/generateStoryboardApi";
import route54 from "./routes/storyboard/generateVideoPrompt";
import route55 from "./routes/storyboard/getStoryboard";
import route56 from "./routes/storyboard/keepStoryboard";
import route57 from "./routes/storyboard/saveStoryboard";
import route58 from "./routes/storyboard/uploadImage";
import route59 from "./routes/task/getTaskApi";
import route60 from "./routes/task/taskDetails";
import route61 from "./routes/user/getUser";
import route62 from "./routes/video/addVideo";
import route63 from "./routes/video/addVideoConfig";
import route64 from "./routes/video/deleteVideoConfig";
import route65 from "./routes/video/generatePrompt";
import route66 from "./routes/video/generateVideo";
import route67 from "./routes/video/getManufacturer";
import route68 from "./routes/video/getVideo";
import route69 from "./routes/video/getVideoConfigs";
import route70 from "./routes/video/getVideoModel";
import route71 from "./routes/video/getVideoStoryboards";
import route72 from "./routes/video/reviseVideoStoryboards";
import route73 from "./routes/video/saveVideo";
import route74 from "./routes/video/upDateVideoConfig";
...
export default async (app: Express) => {
  ...
  app.use("/setting/getSetting", route48);
  app.use("/setting/updeteModel", route49);
  app.use("/storyboard/batchSuperScoreImage", route50);
  app.use("/storyboard/chatStoryboard", route51);
  app.use("/storyboard/generateShotImage", route52);
  app.use("/storyboard/generateStoryboardApi", route53);
  app.use("/storyboard/generateVideoPrompt", route54);
  app.use("/storyboard/getStoryboard", route55);
  app.use("/storyboard/keepStoryboard", route56);
  app.use("/storyboard/saveStoryboard", route57);
  app.use("/storyboard/uploadImage", route58);
  app.use("/task/getTaskApi", route59);
  app.use("/task/taskDetails", route60);
  app.use("/user/getUser", route61);
  app.use("/video/addVideo", route62);
  app.use("/video/addVideoConfig", route63);
  app.use("/video/deleteVideoConfig", route64);
  app.use("/video/generatePrompt", route65);
  app.use("/video/generateVideo", route66);
  app.use("/video/getManufacturer", route67);
  app.use("/video/getVideo", route68);
  app.use("/video/getVideoConfigs", route69);
  app.use("/video/getVideoModel", route70);
  app.use("/video/getVideoStoryboards", route71);
  app.use("/video/reviseVideoStoryboards", route72);
  app.use("/video/saveVideo", route73);
  app.use("/video/upDateVideoConfig", route74);
}

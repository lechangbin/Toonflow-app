...
Toonflow распространяется по лицензии Apache-2.0, подробности: https://www.apache.org/licenses/LICENSE-2.0

Вы можете использовать Toonflow для любых целей, включая коммерцию, при соблюдении условий Apache-2.0.

...
Toonflow เป็นโอเพ่นซอร์สภายใต้ Apache-2.0 รายละเอียดที่: https://www.apache.org/licenses/LICENSE-2.0

สามารถใช้งาน Toonflow ได้ทุกวัตถุประสงค์ ไม่เว้นเชิงพาณิชย์ ตราบเท่าที่ปฏิบัติตาม Apache-2.0
